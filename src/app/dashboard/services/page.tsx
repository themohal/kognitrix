...
import {
  FileText, Code, FileSearch, ImageIcon, Database, Languages, ArrowRight,, ClipboardCheckIcon,
} from "lucide-react";

const iconMap: Record<string, React.ElementType> = {
  FileText, Code, FileSearch, ImageIcon, Database, Languages, ClipboardCheckIcon,
};
